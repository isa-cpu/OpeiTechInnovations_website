  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li><a class="navbar-brand" href="#">WebSiteName</a></li>
        ...
        <li class="<?php if($page == 'about'){die($page);}?>"><a href="about.php" style="color: white">About </a></li>
        <li class="dropdown dropdown-me" class="<?php if($page == 'web' || 'w_app' || 'app' || 'consult' || 'train'){echo 'active';}?>">
